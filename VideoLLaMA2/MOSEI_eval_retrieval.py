...
def parse_args():
    parser = argparse.ArgumentParser(description="MOSEI Eval Retrieval")
    ...
    parser.add_argument(
        "--answer_path", type=str, default="/path/to/MissRAG/VideoLLaMA2/results/MOSEI_eval_retrieval.json"
    )
    parser.add_argument(
...
if __name__ == "__main__":
    ...
    dataset = MOSEI(processor=processor['video'], root=args.root, test_IB_path=args.test_IB_embeddings_path)   
