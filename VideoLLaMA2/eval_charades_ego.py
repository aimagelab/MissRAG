...
def parse_args():
    parser = argparse.ArgumentParser(description="Eval CharadesEGO")
...
class CaptionDataset(Dataset):
    def __init__(self, processor, test_path, video_path, audio_path) -> None:
        super().__init__()
    ...
    def __getitem__(self, index):
        ...
        return audio_video_tensor['video'], audio_video_tensor['audio'], video_id
...
if __name__ == "__main__":
    ...
    dataset = CaptionDataset(test_path=args.test_path, video_path=args.video_path, audio_path=args.audio_path, processor=processor['video'])   
