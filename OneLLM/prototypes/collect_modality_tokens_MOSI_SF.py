...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--answer_path", type=str, default="/path/to/MissRAG/OneLLM/prototypes/data/modality_tokens/train/MOSI_SF"
    )
    ...
    for sample in tqdm(dataloader):
        ...
        torch.save(video_tokens_np, f"{args.answer_path}/MOSI_video_tokens_{index}.pt")
        torch.save(audio_tokens_np, f"{args.answer_path}/MOSI_audio_tokens_{index}.pt")
