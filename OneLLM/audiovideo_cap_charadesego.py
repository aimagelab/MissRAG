...
class CaptionDataset(Dataset):
    def __init__(self, test_path, video_path, audio_path) -> None:
        super().__init__()
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--answer_path", type=str, default="/path/to/MissRAG/results/eval_charadesego.json", help="Path to save the answer"
    )
    ...
    result = {}
    print("Starting...")
    dataset = CaptionDataset(test_path=args.test_path, video_path=args.video_path, audio_path=args.audio_path)
